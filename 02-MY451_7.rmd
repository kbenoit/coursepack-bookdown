...
\@ref(t-groupex) have thus been partially made up for use here. They are,
...
Table \@ref(t-groupex). As in Example 7.3, not all of the numbers needed
here were given in the original article. Specifically, the standard
error of the difference in Table \@ref(t-groupex) has been made up in
...
Table \@ref(t-groupex) shows such statistics for the examples of this
...
(\@ref(H01)) can also be expressed as
...
\@ref(t-groupex). The standard error of $\overline{D}$ is thus
