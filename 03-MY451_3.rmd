...
(ESS) which we used in Chapter \ref{c_descr1} (see page
...
\ref{s_samples_samples}. In the experiment, the participants were a
...
Table \ref{t_attitude} on page \pageref{t_attitude}.
  ...
  : Attitude towards income redistribution by sex, in a hypothetical
...
\ref{t_sex_attitude_pop}, but the language of probabilities is more
appropriate in other cases. We can then say that Table
\ref{t_sex_attitude_pop} shows two sets of **conditional probabilities**
...
-   Chapter \ref{c_means}: Means of continuous variables (probability
