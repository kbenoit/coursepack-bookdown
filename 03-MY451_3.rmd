...
Table \@ref(t-attitude) on page \pageref{t_attitude}.
  ...
  data-label="tab:t-sex-attitude-pop"></span>
...
\@ref(t-sex-attitude-pop). The frequencies in this table desribe the
...
distributions in terms of proportions. Table \@ref(t-sex-attitude-pop)
...
\@ref(t-sex-attitude-pop), but the language of probabilities is more
appropriate in other cases. We can then say that Table
\@ref(t-sex-attitude-pop) shows two sets of **conditional probabilities**
...
\@ref(t-sex-attitude-pop). First, it applies also for continuous
