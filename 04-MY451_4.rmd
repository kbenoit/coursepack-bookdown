...
population}.
\label{eq:H0_chi2}$$ In our example the null hypothesis is thus that a
...
population}.
\label{eq:Ha_chi2}$$ In terms of conditional distributions, $H_{a}$ is that
...
-   Finally, aggregating these quantities to get the $\chi^{2}$ test
    ...
    \label{eq:chi2}$$ Here the summation sign $\Sigma$ indicates that
