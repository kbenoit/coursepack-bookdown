...
\\
%{\Large Michaelmas Term 2005}\\[15ex]
{\Large 2015-16}\\
...
%All registered LSE students will be provided with ONE course pack free
%of charge.

%Supplementary Reading
%Robert Perry and John D. Robertson (2002), Comparative Analysis of Nations: Quantitative Approaches. Westview Press.
%Champney,L Introduction to Quantitative Political Science, Harper Collins College Publishers, 1995.  This book gives multiple examples of how statistical techniques are commonly used in political science.  Also,   Pennings, Paul, Hans Keman \& Kleinnijenhuis Doing Research in Political Science: An Introduction to comparative methods and statistics by.
...
\subsubsection{Advisory Sessions}
...
%Substantial parts of this coursepack were rewritten and rearranged for
%2012-13. Many new typographical errors and other flaws will no doubt
%have been introduced in the process. Please do tell us about any that
%you discover.
...
\textbf{Does the coursepack contain everything I need
...
% A
%very large proportion of it, but the course pack is not a text-book. Its
%purpose is to save you the trouble of struggling to write down detailed
%notes in the lecture and to enable you to give more attention to what is
%said.
...
%The course-pack is a set of notes. It
%is inevitable that it won't contain everything that is said in the
%lecture. It would be boring in the extreme if all the lecturer did was
%simply go through the course-pack word for word. Strictly speaking the
%examinable course consists of the lectures, the coursepack and the
%readings from the textbooks.

%Can I pass the exam without looking at Healey or an equivalent textbook?
%Probably not.
...
%I have lost my coursepack: can I get a new one? Each student is entitled
%to one course pack gratis. If you lose your pack you will have to
%download a copy from the MI public folders on MS Outlook or the Mi451
%WebCT page and print it out yourself.
...
%\textbf{Can I submit my homework by email?} No, not normally. It takes
%time and effort to print out emailed submissions and there is no
%guarantee that what is printed out on our printers will be formatted in
%the way you intend. However, your class teacher may allow this if he/she
%has a different preference.
%An exception may also be made
%if you are officially registered as a part-time student and
%therefore are only able to attend the School on particular days.
