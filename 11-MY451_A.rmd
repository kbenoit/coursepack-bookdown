...
-   To access IT facilities at LSE you need an IT account with its
    **Username** and **Password**. Please see
    <http://www.lse.ac.uk/intranet/LSEServices/IMT/guides/accounts/activateAccount.aspx> for instructions on how to
...
<http://www.lse.ac.uk/intranet/LSEServices/IMT/guides/printing.aspx> for further information.
...
<http://www.lse.ac.uk/methodology/whosWho/Jackson/jackson_ESS.aspx> [^1]
...
### Table of critical values for $\chi^{2}$ distributions {-}
...
[^8]: The data can be obtained from <http://www..norc.org/GSS+Website/>, which
    gives further information on the survey, including the full text of
    the questionnaires.
