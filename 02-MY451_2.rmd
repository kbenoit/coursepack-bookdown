...
data-label="fig:f-bars_region"></span>](regions){height="9.5cm"}

![Bar chart of the democracy index in the country data.<span
data-label="fig:f-bars_democ"></span>](democ){height="9.5cm"}

![Bar chart of the attitude variable in the survey data example.<span
data-label="fig:f-bars_attitude"></span>](bar_attitude "fig:"){height="8cm"}
\scriptsize{
...
data-label="fig:f-hist_gdp"></span>](gdp){width="13.5cm"}
...
($n=155$).<span
data-label="fig:f-boxplot_gdp"></span>](box_gdp){width="15cm"}
