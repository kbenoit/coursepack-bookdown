...
applicant and whether he or she was admitted to the university.
  ...
  admitted within each row. $\chi^{2}=38.4$, $df=1$, $P<0.001$.<span data-label="tab:t-berkeley1"></span>
...
sex and admission is shown in Table \@ref(t-berkeley2).
  ...
  Berkeley admissions data. <span data-label="tab:t-berkeley2"></span>
...
departments and fewer to the easy ones.
  ...
  in the Berkeley admissions data.<span data-label="tab:t-berkeley3"></span>
...
original two-way table are thus unchanged after controlling for sex.
  ...
  **MEN**                                                                                                        \    Slightly           \        Very       \
  ...
  data-label="tab:t-investors3"></span>
...
were more likely to survive than male passengers or the ship’s crew.
  ...
  non-survivors within each group. $\chi^{2}=418$, $\text{df}=2$, $P<0.001$.<span data-label="tab:t-titanic2"></span>
...
$\chi^{2}=344$ and $P<0.001$.
  ...
  within rows. <span data-label="tab:t-titanic3"></span>
...
variables. One such variable is the age of the respondents.
  ...
  proportions within rows.<span data-label="tab:t-whickham1"></span>
...
\@ref(t-investors3) and \@ref(t-titanic3). This is because one variable,
...
associations between the control variable and the other two variables.
  ...
  data-label="tab:t-whickham2"></span>
...
respondents overall were in this age group.
  ...
  (within age groups). <span data-label="tab:t-whickham3"></span>
