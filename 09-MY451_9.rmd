...
of Section \ref{s_regression_multiple}. Here, however, we will not
...
\ref{t_berkeley1} shows the two-way contingency table of the sex of the
applicant and whether he or she was admitted to the university.
  ...
  admitted within each row.<span data-label="t_berkeley1"></span>
...
sex and admission is shown in Table \ref{t_berkeley2}.
  ...
  \multicolumn{2}{|l}{$\,$ }   \multicolumn{4}{l|}{$\chi^{2}=0.75$, $P=0.39$}                                                   
  ...
  \multicolumn{2}{|l}{$\,$ }   \multicolumn{4}{l|}{$\chi^{2}=0.30$, $P=0.59$}                                                   
  ...
  \multicolumn{2}{|l}{$\,$ }   \multicolumn{4}{l|}{$\chi^{2}=1.00$, $P=0.32$}                                                   
  ...
  \multicolumn{2}{|l}{$\,$ }   \multicolumn{4}{l|}{$\chi^{2}=0.38$, $P=0.54$}                                                   
...
Table \ref{t_berkeley2} is a *three-way* contingency table, because each
...
Table \ref{t_berkeley2} is presented in the form of a series of tables
...
Table \ref{t_berkeley2} also contains the marginal distributions of sex
...
This information, summarised in Table \ref{t_berkeley3}, is discussed
further below.
...
apparent association in Table \ref{t_berkeley1} is thus spurious, and
...
departments, as shown in Table \ref{t_berkeley3}. Department is clearly
...
Table \ref{t_berkeley1}. In essence, women had a lower admission rate
...
$\chi^{2}$ test of independence. Table \ref{t_investors3} shows the
...
original two-way table are thus unchanged after controlling for sex.
  ...
  -------------------------------------------------------- ------------------------------------------------------- ----------- ----------- ----------- -------
  **MEN**                                                    \multicolumn{4}{|c|}{Importance of short-term gains }                                     
  ...
  The numbers below the frequencies are proportions within rows.<span
  data-label="t_investors3"></span>

  -------------------------------------------------------- ------------------------------------------------------- ----------- ----------- ----------- -------
  **WOMEN**                                                  \multicolumn{4}{|c|}{Importance of short-term gains }                                     
...
were more likely to survive than male passengers or the ship’s crew.
  ...
  non-survivors within each group.<span data-label="t_titanic2"></span>
...
survival status for them is given by Table \ref{t_titanic2}, ignoring
...
\ref{t_titanic3} are then partial associations between the response
...
never having smoked. Table \ref{t_whickham1} shows the
...
Table \ref{t_whickham2} shows the partial tables of smoking vs.\survival
...
different from those shown in Tables \ref{t_berkeley2},
...
associations between the control variable and the other two variables.
  ...
  ---------------- ----------------------------------------------- -------------------------------------------- --------- ------------
                     \multicolumn{2}{|c|}{\% Alive after 20 years}   \multicolumn{2}{|c|}{Number (in 1972--74)}           
...
respondents overall were in this age group.
  ...
  --------- ------------- --------------------------------------- ----------------------------- ------------------------ -------
                           \multicolumn{2}{c}{Row and column \%}   \multicolumn{2}{|c|}{Total}                           
    % Alive Age group                     Smokers                          Nonsmokers            \multicolumn{1}{c}{\%}    Count
...
-   Extension of the ideas of three-way tables to four-way and larger
    ...
    \ref{t_berkeley2}, except that each partial table for sex
...
-   The only inferential tool for multiway contingency tables discussed
    ...
    \ref{s_regression_multiple}, but modified so that they become
