# Analysis of 3-way contingency tables {#c_3waytables}

In Section \@ref(s_descr1_2cat) and Chapter \@ref(c-tables) we discussed
...
of Section \@ref(s_regression-multiple). Here, however, we will not
...
Table \@ref(t-berkeley1) summarises data on applications for admission to
...
\@ref(t-berkeley1) shows the two-way contingency table of the sex of the
applicant and whether he or she was admitted to the university.
  ...
  : Table of sex of applicant vs. admission in the Berkeley admissions
  data. The column labelled ‘% Yes’ is the percentage of applicants
  admitted within each row. $\chi^{2}=38.4$, $df=1$, $P<0.001$.<span data-label="t_berkeley1"></span>


The percentages in Table \@ref(t-berkeley1) show that men were more
...
sex and admission is shown in Table \@ref(t-berkeley2).
  ...
  :  Sex of applicant vs. admission by academic department in the
  Berkeley admissions data. <span data-label="t_berkeley2"></span>

Table \@ref(t-berkeley2) is a *three-way* contingency table, because each
...
Table \@ref(t-berkeley2) is presented in the form of a series of tables
of sex vs. admission, just like in the original two-way table
\@ref(t-berkeley1), but now with one table for each department. These are
...
Table \@ref(t-berkeley2) also contains the marginal distributions of sex
...
This information, summarised in Table \@ref(t-berkeley3), is discussed
further below.
...
apparent association in Table \@ref(t-berkeley1) is thus spurious, and
...
departments, as shown in Table \@ref(t-berkeley3). Department is clearly
...
Table \@ref(t-berkeley1). In essence, women had a lower admission rate
...
departments and fewer to the easy ones.
  ...
  : Percentages of male applicants and applicants admitted by department
  in the Berkeley admissions data.<span data-label="t_berkeley3"></span>
...
\@ref(f-xyzspurious). There are, however, other possibilities which may
...
Table \@ref(t-investors) on page \pageref{t_investors} showed a
...
$\chi^{2}$ test of independence. Table \@ref(t-investors3) shows the
...
original two-way table are thus unchanged after controlling for sex.
  ...
  **MEN**                                                                                                        \    Slightly           \        Very       \
  ...
  :  Frequencies of respondents by age group and attitude towards
  short-term gains in Example 9.2, controlling for sex of respondent.
  The numbers below the frequencies are proportions within rows. $\chi^{2}=82.4$, $df=9$, $P<0.001$. $\gamma=-0.376$.<span
  data-label="t_investors3"></span>
  ...
  **WOMEN**                                                                                                           Slightly                    Very
  ...
  :  Frequencies of respondents by age group and attitude towards
  short-term gains in Example 9.2, controlling for sex of respondent.
  The numbers below the frequencies are proportions within rows. $\chi^{2}=27.6$, $df=9$, $P=0.001$. $\gamma=-0.395$.<span
  data-label="t_investors3"></span>
...
\@ref(t-titanic2) shows a crosstabulation of the people on board the
...
were more likely to survive than male passengers or the ship’s crew.
  ...
  : Survival status of the people aboard the *Titanic*, divided into
  three groups. The numbers in brackets are proportions of survivors and
  non-survivors within each group. $\chi^{2}=418$, $\text{df}=2$, $P<0.001$.<span data-label="t_titanic2"></span>
...
survival status for them is given by Table \@ref(t-titanic2), ignoring
...
$\chi^{2}=344$ and $P<0.001$.
  ...
  :  Survival status of the passengers of the *Titanic*, classified by
  class and sex. The numbers below the frequencies are proportions
  within rows. <span data-label="t_titanic3"></span>
...
survival. This is investigated in Table \@ref(t-titanic3), which shows
...
\@ref(t-titanic2) are thus preserved and similar in every partial table
...
\@ref(t-titanic3) are then partial associations between the response
...
never having smoked. Table \@ref(t-whickham1) shows the
...
variables. One such variable is the age of the respondents.
  ...
  : Table of smoking status in 1972–74 vs. twenty-year survival among
  the respondents in Example 9.4. The numbers below the frequencies are
  proportions within rows.<span data-label="t_whickham1"></span>

Table \@ref(t-whickham2) shows the partial tables of smoking vs.\survival
...
different from those shown in Tables \@ref(t-berkeley2),
\@ref(t_investors3) and \@ref(t-titanic3). This is because one variable,
...
The percentages in Table \@ref(t-whickham2) show that in five of the
...
opposite direction from the association in Table \@ref(t-whickham1). This
...
associations between the control variable and the other two variables.
  ...
  : Percentage of respondents in Example 9.4 surviving at the time of
  the second survey, by smoking status and age group in 1972–74.<span
  data-label="t_whickham2"></span>


The two-way tables of age by survival and age by smoking are shown side
by side in Table \@ref(t-whickham3). The table is somewhat elaborate and
...
respondents overall were in this age group.
  ...
  : Two-way contingency tables of age group vs. survival (on the left)
  ...
  (within age groups). <span data-label="t_whickham3"></span>

Table \@ref(t-whickham3) shows a clear association between age and
...
-   Extension of the ideas of three-way tables to four-way and larger
    ...
    \@ref(t-berkeley2), except that each partial table for sex
...
-   The only inferential tool for multiway contingency tables discussed
    ...
    \@ref(s_regression-multiple), but modified so that they become
