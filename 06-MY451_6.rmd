...
data-label="fig:f-bp1"></span>](bloodp1){width="13.5cm"}
...
Figure \@ref(f-bp1). Table \@ref(t-bp-example) shows the summary
statistics (\@ref(Ybar-ch6))–(\@ref(s-ch6)) in this sample and the
corresponding parameters (\@ref(mu))–(\@ref(sigma)) in the population.
  ...
  \@ref(s-contd-popdistrs)–\@ref(s-contd-clt).<span
  data-label="tab:t-bp-example"></span>

You may have noticed that the formulas of the sample variance
(\@ref(s2-ch6)) and sample standard deviation (\@ref(s-ch6)) involve the
...
data-label="fig:f-bp2"></span>](bloodp2){width="11.5cm"}
...
banknote.<span data-label="fig:f-10dm"></span>](mark){width="14cm"}
...
data-label="fig:f-3norms"></span>](threenorms){width="11cm"}
...
0.95.<span data-label="fig:f-norm1"></span>](norm1){width="12cm"}
...
data-label="fig:f-normbp"></span>](normbp){width="12cm"}
...
\footnotesize
  ...
  p. \pageref{s_disttables_Z}.<span data-label="tab:t-normtab"></span>
...
for the sample in Table \@ref(t-bp-example) we had $\bar{Y}=72.6$ and
...
data-label="fig:f-sampld2"></span>](sampld2_bp){width="12cm"}
...
data-label="fig:f-sampld"></span>](sampld1_bp){width="12cm"}
...
\@ref(pihat-as-ybar) on page \pageref{pihat-as-ybar}). The CLT then tells
us that
...
data-label="fig:f-cltbin"></span>](sampld_p){width="140mm"}
