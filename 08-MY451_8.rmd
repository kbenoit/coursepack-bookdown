...
\label{eq:mu2}\end{equation} Subtracting (\@ref(mu1}) from (\ref{mu2)) leaves us with
...
\label{eq:tbeta-m}\end{equation} This is identical in form to statistic (\@ref(tbeta))
